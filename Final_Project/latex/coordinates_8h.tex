...
\begin{center}
\leavevmode
\includegraphics[width=189pt]{coordinates_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Used to define points on a board. \end{DoxyCompactList}\end{DoxyCompactItemize}
