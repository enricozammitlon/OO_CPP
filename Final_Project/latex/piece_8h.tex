...
\begin{center}
\leavevmode
\includegraphics[width=277pt]{piece_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Abstract/\+Interface for classes of type piece. \end{DoxyCompactList}\end{DoxyCompactItemize}
