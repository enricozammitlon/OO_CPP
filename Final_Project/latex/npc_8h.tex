...
\begin{center}
\leavevmode
\includegraphics[width=242pt]{npc_8h__dep__incl}
\end{center}
\end{figure}
\subsection*{Classes}
...
\begin{DoxyCompactList}\small\item\em A type of player, implements methods targeted for non-\/playable characters (computer controlled) \end{DoxyCompactList}\end{DoxyCompactItemize}
